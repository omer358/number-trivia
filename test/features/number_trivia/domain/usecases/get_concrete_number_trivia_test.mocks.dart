...
// in time_trivira/test/features/number_trivia/domain/usecases/get_concrete_number_trivia_test.dart.
...
import 'package:time_trivira/core/errors/failure.dart' as _i5;
import 'package:time_trivira/core/errors/network_failure.dart' as _i7;
...
/// A class which mocks [NetworkFailure].
///
/// See the documentation for Mockito's code generation for more information.
class MockNetworkFailure extends _i1.Mock implements _i7.NetworkFailure {
  MockNetworkFailure() {
    _i1.throwOnMissingStub(this);
  }
